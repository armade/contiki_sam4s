 ...
 */
static inline int minmea_rescale(struct minmea_float *f, int new_scale)
{
    if (f->scale == 0)
        return 0;
...
// Float introduce an error because of the bits in the mantissa
// To archive better precision use double.
